...
Since the bot is written in TypeScript, you must compile it before running:
...
3. **Build the project**: `npm run build` (creates `dist/` folder with compiled JavaScript)
